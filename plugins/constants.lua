...
@def CREATE_DATABASE {"BEGIN;","CREATE TABLE 'users' ('id' INTEGER PRIMARY KEY NOT NULL, 'user' TEXT NOT NULL, 'pass' TEXT NOT NULL, 'salt' TEXT NOT NULL, 'auth' INTEGER NOT NULL, UNIQUE('user') ON CONFLICT IGNORE);","COMMIT;"}
